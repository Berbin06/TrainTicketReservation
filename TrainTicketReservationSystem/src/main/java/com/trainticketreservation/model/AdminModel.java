...
public class AdminModel {
	...
	public AdminModel(int adminId, String adminName, long adminMobileNumber, String adminPassword, String adminEmail) {
		super();
		this.adminId = adminId;
		this.adminName = adminName;
		this.adminMobileNumber = adminMobileNumber;
	...
	public AdminModel(String adminName, long adminMobileNumber, String adminPassword, String adminEmail) {
		// TODO Auto-generated constructor stub
		this.adminName = adminName;
		this.adminMobileNumber = adminMobileNumber;
		this.adminPassword = adminPassword;
