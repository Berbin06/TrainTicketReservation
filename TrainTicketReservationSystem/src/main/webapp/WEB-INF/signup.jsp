        ...
        <tr>
            ...
            <tr>
                <th>
                    ...
                    <input  type="radio"name="gender" id="reggender" placeholder="Male" required><label  for="">Male</label>
                    <input  type="radio" name="gender"id="reggender" placeholder="Female" required><label  for="">Female</label>
                </th>
            </tr>
