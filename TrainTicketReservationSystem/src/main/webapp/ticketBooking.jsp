...
<form action="booking" onmouseover="check()">
	...
	<centre><h3 class=text-center">BOOK YOUR TICKET</h3><br></centre>
		...
		<input type="number" name="seatcount" value="<% %>" id="Numberseat" min="0" max="6" placeholder="6 No's" required></div>
		...
		<button class="btn btn-warning">Reset</button></div>
	
		
	</div>
</form>
	<div class="col-sm-4"></div><a href="UserHomePage.jsp"><button class="btn btn-success">Back</button></a></div>
</body>
